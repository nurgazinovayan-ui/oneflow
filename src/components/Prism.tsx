...
// Ported as-is from the reactbits Prism component (pasted by the user for the pricing cards'
// background) — a WebGL-rendered glowing rotating prism via ogl, one canvas instance per usage.
