...
// we're not carrying two icon sets. The reference's single `--primary` accent is plain black here
// (by explicit request — no pink anywhere in this bar), rather than this bar's old per-item
// rainbow color scheme. The "lamp" sliding highlight is framer-motion's shared-layout animation
// (`layoutId="lamp"`) exactly as in the reference — it automatically tweens position/size between
// whichever item is currently marked active.
