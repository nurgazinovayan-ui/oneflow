...
// Ported as-is from the reactbits SideRays component (pasted by the user for the start
// screen's background) — a WebGL two-color light-ray sweep via ogl, one canvas per usage.
      ...
      cleanupFunctionRef.current = () => {
        ...
        if (renderer) {
          try {
            ...
            // Context already gone (e.g. tab discarded it) — nothing left to clean up.
          }
        }
